--------------------------------------------------------
--  DDL for View V_ST_ORG_INVOICE_LOADED
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "METSM_OWNER"."V_ST_ORG_INVOICE_LOADED" ("EXTRACT_NAME", "ID_RECORD", "ID_BATCH", "CONTRACT", "NAME", "SURNAME", "CN", "DUEDATE", "PAYMENT", "DATEPAYMENT", "SIGNDATE", "CLOSEDATE", "INSDATE", "PPLNENIE", "PUDALOST", "PLNENIE_ID", "AVGINVOICE", "PRODUCT", "CAMPAIGN", "BIRTHDAY") AS 
