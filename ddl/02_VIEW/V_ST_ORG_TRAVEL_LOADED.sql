--------------------------------------------------------
--  DDL for View V_ST_ORG_TRAVEL_LOADED
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "METSM_OWNER"."V_ST_ORG_TRAVEL_LOADED" ("EXTRACT_NAME", "ID_RECORD", "ID_BATCH", "OLGCONOSK", "OLGCN", "OLGACTTYPE", "OLGPHONE", "OLGPRODTYP", "OLGTITLE", "OLGNAME", "OLGSURNAME", "OLGPERSID", "OLGBIRTHDT", "OLGSTREET", "OLGZIP", "OLGCITI", "OLGENROLDT", "OLGEFFDT", "OLGCLOSEDT", "OLGDUEDTER", "OLGPREMIUM", "OLGVIP", "OLGFOREIGN", "OLGDUMMY", "NK_ADDRESS", "NK_PARTY", "NK_PHONE_NUMBER", "NK_POLICY") AS 
